  ...
  return (
    <>
      ...
      <div className='relative flex bg-white shadow-lg rounded-lg items-center w-full my-5'>
        ...
        <input className='bg-white pl-14 w-full rounded-lg h-[40px] outline-none' type="text"  placeholder='Email/Phone'/>
      </div>
      {/* Password */}
      <div className='relative flex bg-white shadow-lg rounded-lg items-center w-full my-5'>
      ...
      <div className='mb-5 cursor-pointer'>
        <Link href={'/'} className='font-semibold cursor-pointer'>Forgot Password?</Link>
      </div>
